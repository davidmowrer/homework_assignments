...
puts "That means when you turn #{age_20}, you've been alive for #{seconds_in_20_years} seconds,"
puts "and if you make it to #{age_100}, you will have lived #{seconds_in_100_years} seconds. Make them count!"
